...
Im Backend Modul wird jedoch noch nichts weiter angezeigt.
...
danach können wir unsere eigenen definition einbinden.
unsere field definition sind dann bisher so aus :
...
``inputType`` - steht für das Widget.
...
Eine Liste findest du hier : https://docs.contao.org/dev/reference/widgets/
...
im vendor ordner sind reicht auch:
